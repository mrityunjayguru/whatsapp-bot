                ...
                <tr>
                  ...
                  <td>
                    @if($contact->tags->count() > 0)
                      <span class="badge bg-secondary">{{ $contact->tags->first()->tag_name }}</span>
                      @if($contact->tags->count() > 1)
                        <span class="badge bg-light text-dark border" title="{{ $contact->tags->skip(1)->pluck('tag_name')->join(', ') }}">
                          +{{ $contact->tags->count() - 1 }} more
                        </span>
                      @endif
                    @else
                      -
                  ...
                  <td>
                    <div>{{ $contact->conversations_count }}</div>
                  </td>
                  <td>
